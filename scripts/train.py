...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Model to train (lstm, bilstm, gru, tcn, attention, transformer, dilated_conv, dilated_rnn, wavenet, temporal_synergy, tcn_attention, wavenet_rnn). If not specified, trains all models.",
    )
    parser.add_argument(
        "--force",
        action="store_true",
    ...
    models_to_train = ["tcn", "gru", "lstm", "bilstm", "attention", "transformer", "dilated_conv", "dilated_rnn", "wavenet", "temporal_synergy", "tcn_attention", "wavenet_rnn"]
    if args.model:
